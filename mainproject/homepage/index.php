					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
					        <li><a class ="menu active" href="../login/main.php">SIGN IN</a><li>
					        <li><a class ="menu active" href="../signup/signup.php">Register</a><li>
				...
				<div class="contact-caption clearfix">
					...
					<div class="col-md-5 contact-info text-left">
						...
						<div class="info-detail">
							...
							<ul><li><i class="fa fa-envelope"></i><span>Email:</span> XYZ_88@gmail.com</li></ul>
						</div>
					</div>
					<div class="col-md-6 col-md-offset-1 contact-form">
						...
						<form action="index.php" class="form" method="POST">
							...
							<input class="message" name="message" id="message" cols="30" rows="10" placeholder="Message"></textarea>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-6 footer-para">
					<p>All Team Member:Bikash Pokharel,Suresh Thapa,Roshan shreesh shrestha</p>
				</div>
