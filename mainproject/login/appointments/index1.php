...
include 'connection.php';
 error_reporting(0);
  $Userid=$_SESSION['Userid'];
   $doctorsid=$_GET['Surgeons'];
    $date=$newformat = date('Y-m-d',strtotime($_POST['timePick']));
        $time = $_GET['timePick'];
...
$sql = "INSERT INTO appoinmentsregister ( UserId,DoctorId,Date,Time)
VALUES ('$Userid', ' $doctorsid','$date','$time')";

if (mysqli_query($conn, $sql)) {
    echo "<h1><center>Your doctor is appointed successfully</center></h1>";
} else {
