<?php
    ...
    require_once("../mainproject/dbconfig/config.php");    
?>
<!doctype html>
<html>
    <head>
...
<select name="Surgeons" id="Surgeons">
         ...
         <label class="part1">Choose apointment Date:</label><br>
           <input   name="date" type="date" id="datepick"><br>

           <label>Choose apointment Time:</label><br>
         <input type="text" disabled id="timepick" name="time" ><br>
         <script>
         ...
         <div>
            ...
            <textarea placeholder="Write your message" name="message" rows="5" column="30">
